        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="admin/sub_categories/create" data-i18n="nav.dash.crypto">أضافة
                            قسم فرعي جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">االماركات التجارية   </span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href=" " data-i18n="nav.dash.crypto">أضافة ماركة تجارية   </a>
                    </li>
                </ul>
            </li>
